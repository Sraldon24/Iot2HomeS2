"""
============================================================
DOMISAFE FLASK APPLICATION (FINAL CLEAN VERSION)
============================================================
Fixes:
- Hybrid config: config.json → env → default → error
- Removed duplicate CloudDB initialization
- Proper Adafruit feed-name normalization
============================================================
"""
...
# ============================================================
# HYBRID CONFIG LOADER (config.json → env → default → error)
# ============================================================
...
# ============================================================
# Initialize Cloud Database (FINAL / ONLY ONE INSTANCE)
# ============================================================
...
def environment():
    ...
    for (timestamp, t, h) in rows:
        labels.append(timestamp.strftime("%H:%M:%S") if hasattr(timestamp, 'strftime') else str(timestamp))
...
def control_page():
    ...
    return render_template("control.html", device_states=device_states, message=message)
